...
const PUBLIC_SUPPORT_EMAIL = String(process.env.PUBLIC_SUPPORT_EMAIL || process.env.VITE_SUPPORT_EMAIL || process.env.VITE_CONTACT_EMAIL || "info@tryfarely.com").trim();
