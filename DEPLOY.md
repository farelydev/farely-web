...
Cloudflare Email Routing currently forwards `info@tryfarely.com` to the private verified inbox. The private inbox is an internal forwarding destination and must not be shown publicly by Farely.
