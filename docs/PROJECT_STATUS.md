...
Next engineering priority: after the filter-reset deployment is live-verified, choose the first realistic second provider/affiliate source for true side-by-side booking choice, then implement only where Farely has honest provider data.
